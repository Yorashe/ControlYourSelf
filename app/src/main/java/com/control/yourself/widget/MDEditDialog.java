package com.control.yourself.widget;
...
import com.control.yourself.ScreenSizeUtils;
...
public class MDEditDialog implements View.OnClickListener, DialogInterface.OnDismissListener {
    ...
    public void onClick(View view) {
        ...
        if (i == R.id.edit_dialog_leftbtn && mBuilder.getListener() != null) {
            mBuilder.getListener().clickLeftButton(mDialog, mEdit.getText().toString());
            return;
        }

        if (i == R.id.edit_dialog_rightbtn && mBuilder.getListener() != null) {
            mBuilder.getListener().clickRightButton(mDialog, mEdit.getText().toString());
            dismiss();
            return;
        }
    ...
    public interface OnClickEditDialogListener {
        ...
        void clickLeftButton(Dialog view, String editText);

        void clickRightButton(Dialog view, String editText);
