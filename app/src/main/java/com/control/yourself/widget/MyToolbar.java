...
//                view.setBackground
                if (lp instanceof ActionBar.LayoutParams) {
                    ...
                    params.rightMargin = (int) AutoPX(20, getContext());
    ...
    public float AutoPX(int px, Context context) {
    ...
    private void Setletf(String fieldName) {
        try {
            ...
            if (obj instanceof View) {
                View view = (View) obj;
                int width = (int) AutoPX(54, getContext());
...
//                    }else{
//                        params.leftMargin = (int) AutoPX(22,getContext());
//                    }
